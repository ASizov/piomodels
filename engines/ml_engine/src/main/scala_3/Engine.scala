...
case class Query(fecha: String, agencia_id: Long, canal_id: Long, producto_id: Long, vector:Array[Double]=Array(),Week:Long,Month:Long,lag8month:Long,lag4month:Long,lag2month:Long,lag1month:Long)
